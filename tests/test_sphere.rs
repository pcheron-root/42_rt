#[cfg(test)]
mod tests {
    use rt::{Object, Point, Ray, Shape, Sphere, Transform, Vector};
    ...
    fn test_sphere_intersection() {
        ...
        let result = obj.intersect(&ray, 1., 1);
    ...
    fn test_sphere_intersection_0() {
        ...
        let result = obj.intersect(&ray, 1., 1).unwrap();
    ...
    fn test_ray_miss_sphere() {
        ...
        let result = obj.intersect(&ray, 1., 1).is_none();
