...
use rt::{
    light_utils::{shade_it, get_phong_color, get_color_from_ray}, Camera, Canvas, Color, Cone, Disk, Light, Matrix, Object, Point, Ray,
...
pub fn draw(canvas: &mut Canvas, world: &World, camera: &Camera) {
    ...
    for y in 0..canvas.height {
        ...
        for x in 0..canvas.width {
            ...
            canvas.write(x, y, get_color_from_ray(world, &ray, &sky, 1.0, 2));
        }
    }
}
